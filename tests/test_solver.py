...
def test_solver_avoid_loop_in_substitutes():
    s = Solver(
        [
            MeshPoint(
                0,
                Vector3(-1.1291875839233398, -1.1657862663269043, -1.2977023124694824),
            ),
            MeshPoint(
                1, Vector3(-1.1291875839233398, -1.1657862663269043, 0.8831915855407715)
            ),
            MeshPoint(
                2, Vector3(-1.1291875839233398, 0.6939811706542969, -0.9495291113853455)
            ),
            MeshPoint(3, Vector3(-1.1291875839233398, 0.6939811706542969, 1.0)),
            MeshPoint(
                4, Vector3(1.5113141536712646, -1.1657862663269043, -1.2977023124694824)
            ),
            MeshPoint(
                5, Vector3(1.5113141536712646, -1.1657862663269043, -1.1214728355407715)
            ),
            MeshPoint(
                6, Vector3(1.5113141536712646, 0.6939811706542969, -1.2977023124694824)
            ),
            MeshPoint(
                7, Vector3(1.5113141536712646, 0.6939811706542969, -0.7355250120162964)
            ),
            MeshPoint(
                8, Vector3(0.17407408356666565, 0.8677473068237305, -1.465881109237671)
            ),
        ]
    )
...
def test_solver_same_distance():
    s = Solver(
        [
            ...
            MeshPoint(2, Vector3(11, 11, 11)),
            MeshPoint(3, Vector3(21, 22, 23)),
        ]
    )
